    ...
    return (
        <main>
                        ...
                        <div className="w-full px-4">
                            <div className="wow fadeInUp relative z-10 mx-auto max-w-[845px]" data-wow-delay=".25s">
                                <div className="mt-16">
                                    ...
                                    <img
                                        alt="hero" className="mx-auto max-w-full rounded-t-xl rounded-tr-xl"
                                        src="http://s1l8a7o18.hn-bkt.clouddn.com/hero-image.jpg?e=1695724078&token=x6reJMeSscEYCkZHK_kKf1T9vVJIUWne8kYzYqVU:FzMytZixm-XUTctl8WHA4wuZprY="
                                    />
                                </div>
                    ...
                    <div className="-mx-4 flex flex-wrap">
                        <div className="w-full px-4">
                            <div className="mb-12 max-w-[620px] lg:mb-20">
                                ...
                                <h2 className="mb-4 text-3xl font-bold text-dark sm:text-4xl md:text-[42px]">Main Features Of Play</h2>
                    ...
                    <div className="-mx-4 flex flex-wrap">
                        <div className="w-full px-4 md:w-1/2 lg:w-1/4">
                            <div className="wow fadeInUp group mb-12 bg-white" data-wow-delay=".1s">
                                ...
                                <h4 className="mb-3 text-xl font-bold text-dark">Free and Open-Source</h4>
                                <p className="mb-8 text-body-color lg:mb-11">Lorem Ipsum is simply dummy text of the printing and industry.</p>
                                <a href="#" onClick={handleClickDefaultBehavior} className="text-base font-medium text-body-color hover:text-primary">
                                    Learn More
                                </a>
                            </div>
                        </div>
                        <div className="w-full px-4 md:w-1/2 lg:w-1/4">
                            <div className="wow fadeInUp group mb-12 bg-white" data-wow-delay=".15s">
                                ...
                                <h4 className="mb-3 text-xl font-bold text-dark">Multipurpose Template</h4>
                                <p className="mb-8 text-body-color lg:mb-11">Lorem Ipsum is simply dummy text of the printing and industry.</p>
                                <a href="#" onClick={handleClickDefaultBehavior} className="text-base font-medium text-body-color hover:text-primary">
                                    Learn More
                                </a>
                        ...
                        <div className="w-full px-4 md:w-1/2 lg:w-1/4">
                            <div className="wow fadeInUp group mb-12 bg-white" data-wow-delay=".2s">
                                ...
                                <h4 className="mb-3 text-xl font-bold text-dark">High-quality Design</h4>
                                <p className="mb-8 text-body-color lg:mb-11">Lorem Ipsum is simply dummy text of the printing and industry.</p>
                                <a href="#" onClick={handleClickDefaultBehavior} className="text-base font-medium text-body-color hover:text-primary">
                                    Learn More
                                </a>
                        ...
                        <div className="w-full px-4 md:w-1/2 lg:w-1/4">
                            <div className="wow fadeInUp group mb-12 bg-white" data-wow-delay=".25s">
                                ...
                                <h4 className="mb-3 text-xl font-bold text-dark">All Essential Elements</h4>
                                <p className="mb-8 text-body-color lg:mb-11">Lorem Ipsum is simply dummy text of the printing and industry.</p>
                                <a href="#" onClick={handleClickDefaultBehavior} className="text-base font-medium text-body-color hover:text-primary">
                                    Learn More
                                </a>
                            ...
                            <div className="w-full px-4">
                                <div className="items-center justify-between overflow-hidden border lg:flex">
                                    <div className="w-full py-12 px-7 sm:px-12 md:p-16 lg:max-w-[565px] lg:py-9 lg:px-16 xl:max-w-[640px] xl:p-[70px]">
                                        <span className="mb-5 inline-block bg-primary py-2 px-5 text-sm font-medium text-white">About Us</span>
                                        <h2 className="mb-6 text-3xl font-bold text-dark sm:text-4xl sm:leading-snug 2xl:text-[40px]">
                                            Brilliant Toolkit to Build Nextgen Website Faster.
                                        </h2>
                                        <p className="mb-9 text-base leading-relaxed text-body-color">
                                            The main ‘thrust' is to focus on educating attendees on how to best protect highly vulnerable business applications with interactive
                                    ...
                                    <div className="text-center">
                                        <div className="relative z-10 inline-block">
                                            {/*<img src="assets/images/about/about-image.svg" alt="image" className="mx-auto lg:ml-auto" />*/}
                                            <img src="http://s1l8a7o18.hn-bkt.clouddn.com/about-image.svg?e=1695724638&token=x6reJMeSscEYCkZHK_kKf1T9vVJIUWne8kYzYqVU:h8zdLWfI_5TCcWUMB2aMal0QoKY=" alt="image" className="mx-auto lg:ml-auto" />
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section id="pricing" className="relative z-20 overflow-hidden bg-white pt-20 pb-12 lg:pt-[120px] lg:pb-[90px]">
              ...
              "
                            >
                                <span className="mb-2 block text-base font-medium uppercase text-dark">STARTING FROM</span>
                                <h2 className="mb-9 text-[28px] font-semibold text-primary">$ 19.99/mo</h2>

                                <div className="mb-10">
                                    <p className="mb-1 text-base font-medium leading-loose text-body-color">1 User</p>
                                    <p className="mb-1 text-base font-medium leading-loose text-body-color">All UI components</p>
                                    <p className="mb-1 text-base font-medium leading-loose text-body-color">Lifetime access</p>
                                    <p className="mb-1 text-base font-medium leading-loose text-body-color">Free updates</p>
                                    <p className="mb-1 text-base font-medium leading-loose text-body-color">Use on 1 (one) project</p>
                                    <p className="mb-1 text-base font-medium leading-loose text-body-color">3 Months support</p>
                                </div>
              ...
              "
                            >
                                ...
                                <span className="mb-2 block text-base font-medium uppercase text-white">STARTING FROM</span>
                                <h2 className="mb-9 text-[28px] font-semibold text-white">$ 19.99/mo</h2>

                                <div className="mb-10">
                                    <p className="mb-1 text-base font-medium leading-loose text-white">5 User</p>
                                    <p className="mb-1 text-base font-medium leading-loose text-white">All UI components</p>
                                    <p className="mb-1 text-base font-medium leading-loose text-white">Lifetime access</p>
                                    <p className="mb-1 text-base font-medium leading-loose text-white">Free updates</p>
                                    <p className="mb-1 text-base font-medium leading-loose text-white">Use on 1 (one) project</p>
                                    <p className="mb-1 text-base font-medium leading-loose text-white">4 Months support</p>
                                </div>
                                <div className="w-full">
                                    <a
                                        href="#"
              ...
              "
                            >
                                <span className="mb-2 block text-base font-medium uppercase text-dark">STARTING FROM</span>
                                <h2 className="mb-9 text-[28px] font-semibold text-primary">$ 70.99/mo</h2>
                                ...
                                <div className="mb-10">
                                    ...
                                    <p className="mb-1 text-base font-medium leading-loose text-body-color">Lifetime access</p>
                                    <p className="mb-1 text-base font-medium leading-loose text-body-color">Free updates</p>
                                    <p className="mb-1 text-base font-medium leading-loose text-body-color">Use on unlimited project</p>
                                    <p className="mb-1 text-base font-medium leading-loose text-body-color">4 Months support</p>
                                </div>
                                <div className="w-full">
                                    <a
                                        href="#"
                    ...
                    <div className="-mx-4 flex flex-wrap">
                        <div className="w-full px-4">
                            <div className="mx-auto mb-[60px] max-w-[620px] text-center lg:mb-20">
                                ...
                                <h2 className="mb-4 text-3xl font-bold text-dark sm:text-4xl md:text-[42px]">Any Questions? Answered</h2>
                                <p className="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed">
                                    There are many variations of passages of Lorem Ipsum available but the majority have suffered alteration in some form.
                                </p>
                            </div>
              ...
              "
                            >
                                <button className="faq-btn flex w-full items-center text-left">
                                    ...
                                    <div className="w-full">
                                        <h4 className="text-base font-semibold text-black sm:text-lg">How to use TailGrids?</h4>
                                    </div>
                                </button>
                                <div className="faq-content hidden pl-[62px]">
                                    <p className="py-3 text-base leading-relaxed text-body-color">
                                        It takes 2-3 weeks to get your first blog post ready. That includes the in-depth research & creation of your monthly content marketing
              ...
              "
                            >
                                <button className="faq-btn flex w-full items-center text-left">
                                    ...
                                    <div className="w-full">
                                        <h4 className="text-base font-semibold text-black sm:text-lg">How to download icons from LineIcons?</h4>
                                    </div>
                                </button>
                                <div className="faq-content hidden pl-[62px]">
                                    <p className="py-3 text-base leading-relaxed text-body-color">
              ...
              "
                            >
                                <button className="faq-btn flex w-full items-center text-left">
                                    ...
                                    <div className="w-full">
                                        <h4 className="text-base font-semibold text-black sm:text-lg">Is GrayGrids part of UIdeck?</h4>
                                    </div>
                                </button>
                                <div className="faq-content hidden pl-[62px]">
                                    <p className="py-3 text-base leading-relaxed text-body-color">
              ...
              "
                            >
                                <button className="faq-btn flex w-full items-center text-left">
                                    ...
                                    <div className="w-full">
                                        <h4 className="text-base font-semibold text-black sm:text-lg">Can I use this template for commercial project?</h4>
                                    </div>
                                </button>
                                <div className="faq-content hidden pl-[62px]">
                                    <p className="py-3 text-base leading-relaxed text-body-color">
              ...
              "
                            >
                                <button className="faq-btn flex w-full items-center text-left">
                                    ...
                                    <div className="w-full">
                                        <h4 className="text-base font-semibold text-black sm:text-lg">Do you have plan to releasing Play Pro?</h4>
                                    </div>
                                </button>
                                <div className="faq-content hidden pl-[62px]">
                                    <p className="py-3 text-base leading-relaxed text-body-color">
              ...
              "
                            >
                                <button className="faq-btn flex w-full items-center text-left">
                                    ...
                                    <div className="w-full">
                                        <h4 className="text-base font-semibold text-black sm:text-lg">Where and how to host this template?</h4>
                                    </div>
                                </button>
                                <div className="faq-content hidden pl-[62px]">
                                    <p className="py-3 text-base leading-relaxed text-body-color">
                    ...
                    <div className="flex flex-wrap">
                        <div className="mx-4 w-full">
                            <div className="mx-auto mb-[60px] max-w-[620px] text-center lg:mb-20">
                                ...
                                <h2 className="mb-4 text-3xl font-bold text-dark sm:text-4xl md:text-[42px]">What our Client Say</h2>
                                <p className="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed">
                                    There are many variations of passages of Lorem Ipsum available but the majority have suffered alteration in some form.
                                </p>
                            </div>
                            ...
                            >
                                ...
                                <div className="ud-testimonial-info flex items-center">
                                    <div className="ud-testimonial-image mr-5 h-[50px] w-[50px] overflow-hidden rounded-full">
                                        ...
                                        <img src="http://s1l8a7o18.hn-bkt.clouddn.com/author-01.png?e=1695724784&token=x6reJMeSscEYCkZHK_kKf1T9vVJIUWne8kYzYqVU:cPNyFoXT3v4Smw7-Z2qngPmrRx0=" alt="author" />
                                    </div>
                            ...
                            >
                                ...
                                <div className="ud-testimonial-info flex items-center">
                                    <div className="ud-testimonial-image mr-5 h-[50px] w-[50px] overflow-hidden rounded-full">
                                        ...
                                        <img src="http://s1l8a7o18.hn-bkt.clouddn.com/author-02.png?e=1695724812&token=x6reJMeSscEYCkZHK_kKf1T9vVJIUWne8kYzYqVU:MtGyc1NUbAQ9ru53RrocDQHqPfs=" alt="author" />
                                    </div>
                                    <div className="ud-testimonial-meta">
                            ...
                            >
                                ...
                                <div className="ud-testimonial-info flex items-center">
                                    <div className="ud-testimonial-image mr-5 h-[50px] w-[50px] overflow-hidden rounded-full">
                                        ...
                                        <img src="http://s1l8a7o18.hn-bkt.clouddn.com/author-03.png?e=1695724851&token=x6reJMeSscEYCkZHK_kKf1T9vVJIUWne8kYzYqVU:gyC14h1KAMhOHV1MVe3HMzSplVQ=" alt="author" />
                                    </div>
                                    <div className="ud-testimonial-meta">
                                ...
                                <div className="ud-brands-logo flex flex-wrap items-center">
                                    <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
                                        <a href="https://tailgrids.com" target="_blank" rel="nofollow noopner">
                                            ...
                                            <img src="http://s1l8a7o18.hn-bkt.clouddn.com/tailgrids.svg?e=1695724935&token=x6reJMeSscEYCkZHK_kKf1T9vVJIUWne8kYzYqVU:jwP-eXcYBsaRQtr_vzjrtQl4CQY=" alt="tailgrids" className="grayscale duration-300 hover:filter-none" />
                                        </a>
                                    </div>
                                    <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
                                        <a href="https://ayroui.com" target="_blank" rel="nofollow noopner">
                                            ...
                                            <img src="http://s1l8a7o18.hn-bkt.clouddn.com/ayroui.svg?e=1695724978&token=x6reJMeSscEYCkZHK_kKf1T9vVJIUWne8kYzYqVU:dGnQcE8EEgAJyZc2tKRbxqzq8rg=" alt="ayroui" className="grayscale duration-300 hover:filter-none" />
                                        </a>
                                    </div>
                                    <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
                                        <a href="https://uideck.com" target="_blank" rel="nofollow noopner">
                                            ...
                                            <img src="http://s1l8a7o18.hn-bkt.clouddn.com/uideck.svg?e=1695725226&token=x6reJMeSscEYCkZHK_kKf1T9vVJIUWne8kYzYqVU:IUXfXNhQJM2UsnTybZAAMZ5rf2A=" alt="uideck" className="grayscale duration-300 hover:filter-none" />
                                        </a>
                                    </div>
                                    <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
                                        <a href="https://graygrids.com" target="_blank" rel="nofollow noopner">
                                            ...
                                            <img src="http://s1l8a7o18.hn-bkt.clouddn.com/graygrids.svg?e=1695725194&token=x6reJMeSscEYCkZHK_kKf1T9vVJIUWne8kYzYqVU:q69JllgkKerLf-3UYtNSxwkeaaM=" alt="graygrids" className="grayscale duration-300 hover:filter-none" />
                                        </a>
                                    </div>
                                    <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
                                        <a href="https://lineicons.com" target="_blank" rel="nofollow noopner">
                                            ...
                                            <img src="http://s1l8a7o18.hn-bkt.clouddn.com/uideck.svg?e=1695725012&token=x6reJMeSscEYCkZHK_kKf1T9vVJIUWne8kYzYqVU:abGJxgtv1f90T559VYCiQjmAC5s=" alt="lineicons" className="grayscale duration-300 hover:filter-none" />
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="-mx-4 flex flex-wrap">
                        <div className="w-full px-4">
                            <div className="mx-auto mb-[60px] max-w-[620px] text-center">
                                ...
                                <h2 className="mb-4 text-3xl font-bold text-dark sm:text-4xl md:text-[42px]">Meet Our Team</h2>
                                <p className="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed">
                                    There are many variations of passages of Lorem Ipsum available but the majority have suffered alteration in some form.
                                </p>
                            </div>
                    ...
                    <div className="-mx-4 flex flex-wrap justify-center">
                        <div className="w-full px-4 sm:w-1/2 lg:w-1/4">
                            <div className="wow fadeInUp mb-10" data-wow-delay=".1s">
                                <div className="h-170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full">
                                    {/*<img src="assets/images/team/team-01.png" alt="image" className="w-full rounded-full" />*/}
                                    <img src="http://s1l8a7o18.hn-bkt.clouddn.com/team-01.png?e=1695725302&token=x6reJMeSscEYCkZHK_kKf1T9vVJIUWne8kYzYqVU:oBQ1U0Sgznu7z29SF3fVfLiBIVs=" alt="image" className="w-full rounded-full" />
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="mb-5 text-sm font-medium text-body-color">UI Designer</p>
                        ...
                        <div className="w-full px-4 sm:w-1/2 lg:w-1/4">
                            <div className="wow fadeInUp mb-10" data-wow-delay=".15s">
                                <div className="h-170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full">
                                    {/*<img src="assets/images/team/team-02.png" alt="image" className="w-full rounded-full" />*/}
                                    <img src="http://s1l8a7o18.hn-bkt.clouddn.com/team-02.png?e=1695725335&token=x6reJMeSscEYCkZHK_kKf1T9vVJIUWne8kYzYqVU:nCdWQ4homk069jMIDNKlVJHRDJo=" alt="image" className="w-full rounded-full" />
                                    <span className="absolute top-0 left-0 z-[-1]">
                                        <svg width="71" height="82" viewBox="0 0 71 82" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="1.29337" cy="80.7066" r="1.29337" transform="rotate(-90 1.29337 80.7066)" fill="#3056D3" />
                                            <circle cx="12.6747" cy="80.7066" r="1.29337" transform="rotate(-90 12.6747 80.7066)" fill="#3056D3" />
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="mb-5 text-sm font-medium text-body-color">Product Designer</p>
                                    <div className="flex items-center justify-center">
                                        <a
                                            href="#"
                                            onClick={handleClickDefaultBehavior}
                        ...
                        <div className="w-full px-4 sm:w-1/2 lg:w-1/4">
                            <div className="wow fadeInUp mb-10" data-wow-delay=".2s">
                                <div className="h-170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full">
                                    {/*<img src="assets/images/team/team-03.png" alt="image" className="w-full rounded-full" />*/}
                                    <img src="http://s1l8a7o18.hn-bkt.clouddn.com/team-03.png?e=1695725375&token=x6reJMeSscEYCkZHK_kKf1T9vVJIUWne8kYzYqVU:pKRILIIlMVNUry33D4dpEliDpqE=" alt="image" className="w-full rounded-full" />
                                    <span className="absolute top-0 left-0 z-[-1]">
                                        <svg width="71" height="82" viewBox="0 0 71 82" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="1.29337" cy="80.7066" r="1.29337" transform="rotate(-90 1.29337 80.7066)" fill="#3056D3" />
                                            <circle cx="12.6747" cy="80.7066" r="1.29337" transform="rotate(-90 12.6747 80.7066)" fill="#3056D3" />
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="mb-5 text-sm font-medium text-body-color">App Developer</p>
                                    <div className="flex items-center justify-center">
                                        <a
                                            href="#"
                                            onClick={handleClickDefaultBehavior}
                        ...
                        <div className="w-full px-4 sm:w-1/2 lg:w-1/4">
                            <div className="wow fadeInUp mb-10" data-wow-delay=".25s">
                                <div className="h-170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full">
                                    {/*<img src="assets/images/team/team-01.png" alt="image" className="w-full rounded-full" />*/}
                                    <img src="http://s1l8a7o18.hn-bkt.clouddn.com/team-04.png?e=1695725464&token=x6reJMeSscEYCkZHK_kKf1T9vVJIUWne8kYzYqVU:IUWS5fVprOCymFPE5kzPP-1tpdg=" alt="image" className="w-full rounded-full" />
                                    <span className="absolute top-0 left-0 z-[-1]">
                                        <svg width="71" height="82" viewBox="0 0 71 82" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="1.29337" cy="80.7066" r="1.29337" transform="rotate(-90 1.29337 80.7066)" fill="#3056D3" />
                                            <circle cx="12.6747" cy="80.7066" r="1.29337" transform="rotate(-90 12.6747 80.7066)" fill="#3056D3" />
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="mb-5 text-sm font-medium text-body-color">Content Writer</p>
                                    <div className="flex items-center justify-center">
                                        <a
                                            href="#"
                                            onClick={handleClickDefaultBehavior}
                        ...
                        <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
                            <div className="ud-contact-content-wrapper">
                                <div className="ud-contact-title mb-12 lg:mb-[150px]">
                                    <span className="mb-5 text-base font-semibold text-dark">CONTACT US</span>
